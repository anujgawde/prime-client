  ...
  },
  {
    ...
    svg: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        ...
        />
        <path
          d="M2 19c0-3.3 2.7-6 6-6s6 2.7 6 6"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
        <path
          d="M13 13.2c1-.7 2.1-1.2 3.5-1.2 3 0 5.5 2.7 5.5 6"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
    ...
    <div className="min-h-screen bg-bg-base text-text-primary font-sans overflow-x-hidden">
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-50 px-6 md:px-12 py-4 flex items-center transition-all duration-300 ${
          scrolled
            ? "bg-bg-base/85 backdrop-blur-md shadow-[0_1px_0_var(--color-border-subtle,#E4E0EC)]"
            : ""
        }`}
      >
      ...
      <section className="relative pt-40 md:pt-44 pb-24 md:pb-28 px-6 md:px-12 text-center overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(140,96,243,0.25) 0%, transparent 70%)",
            top: "-120px",
            left: "50%",
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 1px 1px, #c8b5f5 0.8px, transparent 0)",
        ...
        <SR
          delay={0.08}
          as="h1"
          className="relative z-10 font-bold tracking-[-0.04em] leading-[1.05] max-w-3xl mx-auto mb-5"
        >
          <span className="text-[40px] sm:text-5xl md:text-6xl lg:text-7xl block">
            ...
            <span
              ...
              style={{
                backgroundImage:
                  "linear-gradient(135deg, #8C60F3 0%, #b794f6 50%, #6A3ECE 100%)",
              }}
            >
              built for teams.
            </span>
        ...
        <SR
          delay={0.16}
          as="p"
          className="relative z-10 text-lg text-text-secondary leading-relaxed max-w-xl mx-auto mb-9"
        >
          Create polished reports from reusable templates, manage your
          organization, and track every document — all in one focused workspace.
        </SR>

        <SR
          delay={0.24}
          className="relative z-10 flex gap-3 justify-center items-center flex-wrap"
        >
          <button
            onClick={handleGetStarted}
          ...
          <button className="bg-bg-surface text-text-primary border border-border-default font-semibold text-[15px] rounded-md px-8 py-3.5 cursor-pointer hover:bg-bg-hover transition-colors">
            See a Demo
          </button>
        </SR>
        ...
        <SR
          delay={0.32}
          className="relative z-10 max-w-4xl mx-auto mt-16 rounded-xl overflow-hidden border border-border-subtle shadow-[0_24px_80px_rgba(53,49,72,0.12),0_2px_8px_rgba(53,49,72,0.06)]"
        >
          <div
      ...
      <section
        id="features"
        className="py-24 md:py-28 px-6 md:px-12 max-w-6xl mx-auto"
      >
        <SR>
        ...
        <SR
          delay={0.08}
          as="h2"
          className="text-3xl md:text-4xl font-bold tracking-tight leading-tight max-w-xl mb-14"
        >
          Everything you need
          <br />
          to manage documents.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {FEATURES.map((f, i) => (
            <SR
              key={f.title}
              delay={0.08 * ((i % 3) + 1)}
              className="p-7 bg-bg-surface border border-border-subtle rounded-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(53,49,72,0.08)]"
            >
      ...
      <section
        id="how"
        className="py-24 md:py-28 px-6 md:px-12 bg-text-primary text-white relative overflow-hidden"
      >
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            backgroundImage:
              "radial-gradient(circle at 1px 1px, rgba(140,96,243,0.15) 0.8px, transparent 0)",
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <SR
            delay={0.08}
            as="h2"
            className="text-3xl md:text-4xl font-bold tracking-tight leading-tight mb-16 text-white"
          >
            ...
            {STEPS.map((s, i) => (
              <SR key={s.num} delay={0.08 * (i + 1)} className="relative">
                <div
                  ...
                  style={{ color: "rgba(140,96,243,0.2)" }}
                >
                  {s.num}
                </div>
      ...
      <section className="py-24 px-6 md:px-12 text-center relative overflow-hidden">
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(140,96,243,0.15) 0%, transparent 70%)",
            top: "50%",
            left: "50%",
        ...
        <SR
          as="h2"
          className="relative z-10 text-3xl md:text-4xl font-bold tracking-tight mb-4"
        >
        ...
        <SR
          delay={0.08}
          as="p"
          className="relative z-10 text-base text-text-secondary mb-8 max-w-md mx-auto"
        >
          Start creating professional documents with your team today. Free
          during beta.
        </SR>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-10">
          <div className="col-span-2 max-w-60">
            ...
            <p className="text-[13px] text-text-secondary leading-relaxed">
              Document workflows, built for teams. Create reports from reusable
              templates, manage your organization, and track usage.
            </p>
          </div>
          <div>
            <h4 className="text-xs font-semibold tracking-[0.06em] uppercase text-text-secondary mb-3.5">
              Product
            </h4>
            <a
              href="#"
              className="block text-[13px] text-text-secondary py-1 no-underline hover:text-text-primary"
            >
              Features
            </a>
            <a
